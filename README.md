...
pip install scikit-learn profilehooks progressbar matplotlib tensorboard plotly flake8 tqdm minigrid tensorboard-reducer torchinfo pyarrow natsort gymnasium[other]
